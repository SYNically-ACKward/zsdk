...
class intermediate_ca_certificates(Endpoint):
    def list(
        ...
        result = self._req(
            method="get",
            path="/intermediateCaCertificate",
            params=params
        )
    ...
    def get_csr(
        ...
        result = self._req(
            method="get",
            path=f"/intermediateCaCertificate/downloadCsr/{cert_id}"
        )
    ...
    def get_public_key(
        ...
        result = self._req(
            method="get",
            path=f"/intermediateCaCertificate/downloadPublicKey/{cert_id}"
        )
    ...
    def finalize(
        ...
        result = self._req(
            method="post",
            path=f"/intermediateCaCertificate/finalizeCert/{cert_id}"
        )
    ...
    def create_key_pair(
        ...
        result = self._req(
            method="post",
            path=f"/intermediateCaCertificate/keyPair/{cert_id}"
        )
    ...
    def list_lite(
        ...
        result = self._req(
            method="get",
            path="/intermediateCaCertificate/lite",
            params=params
        )
    ...
    def get_lite(
        ...
        result = self._req(
            method="post",
            path=f"/intermediateCaCertificate/lite/{cert_id}"
        )
    ...
    def update_default(
        ...
        result = self._req(
            method="put",
            path=f"/intermediateCaCertificate/makeDefault/{cert_id}"
        )
    ...
    def get_ready_certs(
        ...
        result = self._req(
            method="get",
            path="/intermediateCaCertificate/readyToUse",
            params=params
        )

        return result.json()

    def show_signed_cert(
            self,
            cert_id: int
    ) -> List[dict]:
        """
        ...
        result = self._req(
            method="get",
            path=f"/intermediateCaCertificate/showCert/{cert_id}"
        )
    ...
    def upload_cert_chain(
        ...
        files = [
            ("fileUpload", ("file", open(cert_chain_path), "rb"), "application/octet-stream")
        ]
        result = self._req(
            method="post",
    ...
    def get(
        ...
        result = self._req(
            method="get",
            path=f"/intermediateCaCertificate/{cert_id}"
        )
